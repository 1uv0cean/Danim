...
type ReservationScreenNavigationProps = StackNavigationProp<
    HomeStackParamList,
    HomeScreens.Reservation
>;

interface ReservationScreenProps {
    navigation: ReservationScreenNavigationProps;
}
...
const Reservation: React.FunctionComponent<ReservationScreenProps> = () => {
return (
