...
const MyPage: React.FunctionComponent<MyPageScreenProps> = props => {
  ...
  // userPhone parameter 가져오기
  const userPhone = props.route.params.userPhone;
  return (
    <View style={styles.container}>
      ...
      <View style={styles.personalInfoView}>
        ...
        <TouchableOpacity
          onPress={() =>
            navigation.navigate(HomeScreens.EditProfile, {
              userPhone: userPhone,
            })
          }>
          <Image
            style={styles.allowsImage}
      ...
      <View style={styles.disabilityView}>
        ...
        <TouchableOpacity
          onPress={() =>
            navigation.navigate(HomeScreens.EditRegistration, {
              userPhone: userPhone,
            })
          }>
          <Image
